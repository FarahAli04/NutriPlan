...
export async function fireRecipeInstruction(mealId) {
  ...
  `
    ...
    // close modal when pressed outside the modal
...
const meal = {
    ...
    nutrition: {
        ...
        protein: analysisData.perServing.protein * servings,
        carbs: analysisData.perServing.carbs * servings,
        fat: analysisData.perServing.fat * servings,
        sugar: analysisData.perServing.sugar * servings,
        fiber: analysisData.perServing.fiber * servings
    }
};
